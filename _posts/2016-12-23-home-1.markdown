...
![itcss](/nicecss/assets/itcss.svg)
...
There's a lot out there about [how spcifically OOCSS should be writen](https://ianstormtaylor.com/oocss-plus-sass-is-the-best-way-to-css), which is often compelling and worth looking into, but IMO OOCSS really has the most value when appreciated as a principle rather than a collection of rules. Which is also true of a lot of other things. And as you'll see the methodologies to come are increasingly prescriptive and generally work well with OOCSS principles.
...
There's a bunch of articles [comparing OOCSS and SMACSS](https://www.sitepoint.com/bem-smacss-advice-from-developers) that sometimes get insanely technical and maybe matter but probably doen't. Your two choices are ultimately not SMACSS vs OOCSS but rather fucking things up vs spending all your time trying to develop the prefect set up that will prevent you from fucking up.
